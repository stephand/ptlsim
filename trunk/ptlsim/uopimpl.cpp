...
#ifdef __x86_64__
//
// These are way to difficult to emulate on regular 32-bit x86, since there is
// no equivalent SSE instruction and x87 fails to do SSE-style rounding.
//
// Fortunately these are only generated by the x86 translator for x86-64
// code, so we have no reason to implement them in PTLsim32.
//
