     ...
     enum machine_mode mode;
{
  ...
  high = CONST_DOUBLE_LOW  (op);
  low = CONST_DOUBLE_HIGH  (op);
#else
...
#else
#ifdef HOST_WORDS_BIG_ENDIAN
  if((high&0xfffff)!=0 || low !=0               /* not a power of two */
      || (high&0x7ff00000)==0                   /* constant 0.0 */
      || (high&0x7ff00000) == 0x7ff00000        /* NAN */
      || ((high&0x78000000) != 8 && (high&0x78000000) != 7))
#else
  if((low&0xfffff)!=0 || high !=0               /* not a power of two */
      || (low&0x7ff00000)==0                   /* constant 0.0 */
      || (low&0x7ff00000) == 0x7ff00000        /* NAN */
      || ((low&0x78000000) != 8 && (low&0x78000000) != 7))
#endif
#endif
...
#else
#ifdef HOST_WORDS_BIG_ENDIAN
      if((0 == CONST_DOUBLE_HIGH(op))
         && ((CONST_DOUBLE_LOW(op)&0x7ff00000) != 0x7ff00000)
         && (((j=(CONST_DOUBLE_LOW(op)&0x78000000)) == 0x40000000) ||
         (j == 0x38000000))
#else
      if((0 == CONST_DOUBLE_LOW(op))
         && ((CONST_DOUBLE_HIGH(op)&0x7ff00000) != 0x7ff00000)
         && (((j=(CONST_DOUBLE_HIGH(op)&0x78000000)) == 0x40000000) ||
         (j == 0x38000000))
#endif
#endif
