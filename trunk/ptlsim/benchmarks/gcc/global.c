...
static int allocno_compare	PROTO((const void *, const void *));
...
#if 0
static int
 allocno_compare (cvv1, cvv2)
      const void *cvv1, *cvv2;
 {
  int *v1 = (int *) cvv1, *v2 = (int *) cvv2;
...
static int
      ...
      const void *cvv1, *cvv2;
 {
  ...
  pri1 = (10000 * floor_log2(allocno_n_refs[*v1]) * allocno_n_refs[*v1] * 
          allocno_size[*v1]) / allocno_live_length[*v1]; 
  pri2 = (10000 * floor_log2(allocno_n_refs[*v2]) * allocno_n_refs[*v2] * 
          allocno_size[*v2]) / allocno_live_length[*v2]; 
