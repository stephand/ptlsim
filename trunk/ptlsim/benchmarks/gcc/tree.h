...
#ifdef _WIN64
  union {__int64 address; char *pointer; } symtab;
#else
  union {long address; char *pointer; } symtab;
#endif
...
#define DECL_SET_FUNCTION_CODE(NODE,VAL) ((NODE)->decl.frame_size.f = (size_t) (VAL))
...
extern char *oballoc			PROTO((size_t));
extern char *permalloc			PROTO((size_t));
extern char *savealloc			PROTO((size_t));
...

/* In tree.c */
extern char *perm_calloc			PROTO((int, size_t));
