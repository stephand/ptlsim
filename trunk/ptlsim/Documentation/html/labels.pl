...
$key = q/sec:AddressSpaceSimulation/;
...
$key = q/sec:StatisticsInfrastructure/;
...
$key = q/sub:AliasCheck/;
$external_latex_labels{$key} = q|12.2.1|; 
$noresave{$key} = "$nosave";
...
$key = q/table:ArchitecturalRegisters/;
...
$key = q/table:IssueQueueStateMachine/;
$external_latex_labels{$key} = q|9.1|; 
$noresave{$key} = "$nosave";
