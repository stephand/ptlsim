...
static int
rank_for_schedule (cvx, cvy)
     const void *cvx, *cvy;
{
  rtx *x = (rtx *)cvx, *y = (rtx *)cvy;
  rtx tmp = *y;
  rtx tmp2 = *x;
  rtx link;
  ...
  if (reload_completed == 0)
    {
      ...
      old_live_regs = (regset) alloca ((size_t)regset_bytes);
      regs_sometimes_live
  ...
  if (reload_completed == 0)
    {
      ...
      bb_dead_regs = (regset) alloca ((size_t)regset_bytes);
      bb_live_regs = (regset) alloca ((size_t)regset_bytes);
