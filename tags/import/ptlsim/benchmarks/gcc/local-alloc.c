...
static int qty_sugg_compare_1	PROTO((const void *, const void *));
static int qty_compare    	PROTO((int, int));
static int qty_compare_1	PROTO((const void *, const void *));
...
static int
qty_compare_1 (cvq1, cvq2)
     const void *cvq1, *cvq2;
{
  int *q1 = (int *) cvq1, *q2 = (int *) cvq2;
  register int tem;
...
static int
qty_sugg_compare_1 (cq1, cq2)
     const void *cq1, *cq2;
{
  int *q1 = (int *) cq1, *q2 = (int *) cq2;
  register int sugg1 = (qty_phys_num_copy_sugg[*q1]
			? qty_phys_num_copy_sugg[*q1]
			: qty_phys_num_sugg[*q1] * FIRST_PSEUDO_REGISTER);
  register int sugg2 = (qty_phys_num_copy_sugg[*q2]
