     ...
     FILE *dumpfile;
{
  ...
  moved_once = (char *) alloca ((size_t) max_reg_before_loop);
     ...
     int nregs;
{
  ...
  may_not_optimize = (char *) alloca ((size_t) nregs);
...
{
  register struct movable *m;
  char *matched_regs = (char *) alloca ((size_t) nregs);
     ...
     int nregs;
{
  ...
  char *already_moved = (char *) alloca ((size_t) nregs);
     ...
     rtx loop_end;
{
  ...
  reg_iv_type = (enum iv_mode *) alloca (max_reg_before_loop * sizeof (enum iv_mode *));
